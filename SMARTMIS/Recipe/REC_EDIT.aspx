<%@ Page Language="C#" MasterPageFile="~/Recipe/MasterPage.master" AutoEventWireup="true" CodeFile="REC_EDIT.aspx.cs" Inherits="REC_EDIT" Title="Untitled Page" %>
    ...
    <tr >
        <td style="width: 100%" align="center">
             <table align="center" width="50%"  style="background-color:White;">
                   ...
                   <tr>
                    ...
                    <td align="left" class="style1">
                        <asp:DropDownList ID="TxtRecCode" runat="server" AutoPostBack="true" 
                            Height="20px" 
                            Width="200px" ontextchanged="TxtRecCode_TextChanged">
                        </asp:DropDownList>
                    </td>
                    <td align="right" class="style4">
                         Press Make</td>
                    <td align="right">
                        <asp:DropDownList ID="TxtPreMake" runat="server" AutoPostBack="True" 
                            Font-Size="Small" Height="20px" 
                            onselectedindexchanged="TxtPreMake_SelectedIndexChanged" Width="200px">
                        </asp:DropDownList>
                    </td>
                </tr>
                   <tr align="center">
                    ...
                    <td align="left" colspan="3">
                        <asp:TextBox ID="TxtDiscription" runat="server" Height="20px" 
                   ...
                   <tr align="center">
                    ...
                    <td align="left" class="style5">
                        Edited By</td>
                    <td align="left" class="style1">
                        <asp:TextBox ID="TxtEditBy" runat="server" Height="20px" Width="200px" 
                            ontextchanged="TxtCreatedBy_TextChanged" Enabled="False"></asp:TextBox>
                    </td>
                    <td align="right" class="style4">
                         Edited On</td>
                    <td align="right">
             ...
             <table align="center" width="52%">
               <tr align="center" >
                   <td>
                            <asp:Button ID="Button1" runat="server" Text="EDIT" Width="94px" onclick="Button1_Click" />
                    </td>
                </tr> 
                <tr>
                    <td>
                     <asp:Label ID="Label19" align="center"  runat="server" Width="320px" Font-Bold="True"  Font-Strikeout="False" ForeColor="#CC0000" Font-Size="Small" ></asp:Label>
                    </td>
                </tr>               
            </table>    
        <br />
            ...
            <tr align="center" style="background-color:	#736AFF; color: #FFFFFF;">
                ...
                <td class="style2">
                    Time|Temp
                    <asp:CheckBox ID="Sec" runat="server" oncheckedchanged="Sec_CheckedChanged" Text="" AutoPostBack="True" Checked="True"  Visible="false"/>
                </td>
                ...
                <td>
                    <asp:CheckBox ID="PS" runat="server" Text="PS" AutoPostBack="True" 
                        oncheckedchanged="PS_CheckedChanged" Checked="True" />
                </td>
                <td>
