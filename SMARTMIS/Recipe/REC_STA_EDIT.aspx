<%@ Page Language="C#" MasterPageFile ="~/Recipe/MasterPage.master"  AutoEventWireup="true" CodeFile="REC_STA_EDIT.aspx.cs" Inherits="REC_STA_EDIT" %>
           ...
           <table align="center" width="35%"  style="background-color:White;">
                <tr align="center" >
                    <td colspan="2" bgcolor="#FFCCFF">
                            <h2 style="font-family:'Courier New', Courier, monospace; width:100%; height: 35px;" align="center"><span><u>RECIPE STRUCTURE EDIT</u></span> </h2>
            ...
            <tr align="center">
                ...
                <td align="left" >
                    ...
                    <asp:DropDownList ID="txtvalve13" runat="server" Height="16px" Width="182px" 
                        onselectedindexchanged="txtvalve13_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr align="center">
                ...
                <td align="left" >
                    ...
                    <asp:DropDownList ID="txtvalve14" runat="server" Height="16px" Width="182px" 
                        onselectedindexchanged="txtvalve14_SelectedIndexChanged">
                    </asp:DropDownList>
           ...
           <tr align="center">
                ...
                <td align="left" >
                    ...
                    <asp:DropDownList ID="txtvalve15" runat="server" Height="16px" Width="182px" 
                        onselectedindexchanged="txtvalve15_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr align="center">
                ...
                <td align="left" >
                    ...
                    <asp:DropDownList ID="txtvalve16" runat="server" Height="16px" Width="182px" 
                        onselectedindexchanged="txtvalve16_SelectedIndexChanged">
                    </asp:DropDownList>
