<%@ Page Language="C#" MasterPageFile="~/Recipe/MasterPage.master"  AutoEventWireup="true" CodeFile="REC_VIEW.aspx.cs" Inherits="REC_VIEW" %>
             ...
             <table align="center" width="50%"  style="background-color:White;">
                <tr align="center" >
                        <td colspan="4" bgcolor="#FFCCFF">
                                <h2 style="font-family:'Courier New', Courier, monospace; width:100%; height: 35px;" align="center"><span><u>RECIPE VIEW</u></span> </h2>
                ...
                <tr align="center">
                    ...
                    <td align="left" class="style1">
                        <asp:TextBox ID="TxtCreatedBy" runat="server" Enabled="False" Height="20px" 
                            Width="200px" ontextchanged="TxtCreatedBy_TextChanged"></asp:TextBox>
                    </td>
                    <td align="right" class="style4">
                         Created On</td>
                    <td align="right">
                ...
                <tr>
                <td colspan="4" align="center"><asp:Label ID="Label19" align="center"  runat="server" Width="320px" Font-Bold="True" 
