<%@ Page Language="C#" MasterPageFile="~/Recipe/MasterPage.master"  AutoEventWireup="true" CodeFile="REC_NEW.aspx.cs" Inherits="REC_NEW" %>
...
<table width="100%" align="center">
    <tr >
             ...
             <table align="center" width="50%"  style="background-color:White;">
                    <tr align="center" >
                        <td colspan="4" bgcolor="#FFCCFF">
                                <h2 style="font-family:'Courier New', Courier, monospace; width:100%; height: 35px;" align="center"><span><u>RECIPE NEW</u></span> </h2>
                              
                        </td>
                    </tr>
                    <tr align="center">
                         <td align="left"  class="style5"  > Rec. Sample
                         </td>
                        <td align="left" class="style1" colspan="3">                        
                            <asp:DropDownList ID="TxtRecCode1" runat="server" AutoPostBack="true" 
                    ...
                    <tr align="center">
                        ...
                        <td align="left" class="style1">
                            <asp:TextBox ID="TxtRecCode" runat="server" Height="20px" 
                                ontextchanged="TxtRecCode_TextChanged" Width="190px"></asp:TextBox>
                        </td>
                        ...
                        <td align="right">
                            <asp:DropDownList ID="TxtPreMake" runat="server" AutoPostBack="True" 
                                ...
                                onselectedindexchanged="TxtPreMake_SelectedIndexChanged" Width="190px">
                            </asp:DropDownList>
                        </td>
                </tr>
                    <tr align="center">
                    ...
                    <tr align="center">
                        ...
                        <td align="left" class="style5">
                            Created By</td>
                        <td align="left" class="style1">
                            <asp:TextBox ID="TxtCreatedBy" runat="server" Height="20px" Width="190px" 
        ...
        <table align="center" width="90%">
            <tr align="center" 
                style="color: #0000FF; font-weight: bold; font-size: small  ; background-color: #CCCCFF;">
            ...
            <tr align="center" style="background-color:	#736AFF; color: #FFFFFF;">
                ...
                <td class="style2">
                    ...
                    <asp:CheckBox ID="Sec" runat="server" oncheckedchanged="Sec_CheckedChanged" 
                        Text="" AutoPostBack="True" Checked="True" Visible="false" />
                </td>
                <td>
                    &nbsp;</td>
                <td>
