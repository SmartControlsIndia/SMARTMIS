<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="performanceExecutiveReport.aspx.cs" MasterPageFile="~/smartMISTUOReportMaster.Master" Inherits="SmartMIS.TUO.performanceExecutiveReport" Title="Executive Report Recipe Wise" %>


<%@ Register src="../UserControl/reportHeader.ascx" TagName="reportHeader" tagprefix="asp" %>
<%@ Register Src="~/UserControl/QualityPerformanceReportTBMRecipeWise.ascx" TagName="performanceReport2" TagPrefix="asp" %>

<asp:Content ID="plantPerformanceReport2Content" runat="server" ContentPlaceHolderID="tuoReportMasterContentPalceHolder">
