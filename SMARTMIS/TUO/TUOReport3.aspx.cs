...
namespace SmartMIS.TUO
{
    public partial class TUOReport3 : System.Web.UI.Page
    {
        ...
        protected void GridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                for (int rowIndex = performanceAvgReportMainGridView.Rows.Count - 2; rowIndex >= 0; rowIndex--)
                {
                    GridViewRow gvRow = performanceAvgReportMainGridView.Rows[rowIndex];
                    GridViewRow gvPreviousRow = performanceAvgReportMainGridView.Rows[rowIndex + 1];
                    if (((Label)performanceAvgReportMainGridView.Rows[rowIndex].FindControl("performanceAvgReportWCNameLabel")).Text == ((Label)performanceAvgReportMainGridView.Rows[rowIndex + 1].FindControl("performanceAvgReportWCNameLabel")).Text)
                    {
                ...
                {
                    if (((Label)e.Row.FindControl("performanceAvgReportWCNameLabel")).Text == "Grand Total" || ((Label)e.Row.FindControl("performanceAvgReportTyreTypeLabel")).Text == "Total")
                    {
                    ...
                    Label cell;
                    cell = ((Label)e.Row.FindControl("performanceAvgReportCheckedLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportAGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportBGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportCGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportDGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportEGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportRFVCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportRFVCCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportR1HRFVCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportR1HCCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLFVCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLFVCCWGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportCONGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLowerBulgeGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportUpperBulgeGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLowerLROGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportUpperLROGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLowerRROGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportLowerDepGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceAvgReportUpperDepGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                }
                if (((GridView)sender).ID == "performanceAvgReportTBMRecipeWiseMainGridView")
                {
                    Label cell;
                    cell = ((Label)e.Row.FindControl("performanceAvgReportCheckedLabel"));
                    cell.Text = NullIf(cell.Text);
        ...
        private void showReport(string query)
        {
            try
            {
                ...
                dr[0] = "Grand Total";
                dr[1] = "";
                double[] last_row = new double[] { grandGradetotal, grandGradeA, grandGradeB, grandGradeC, grandGradeD, grandGradeE, grandAvgRFVCW, grandAvgRFVCCW, grandAvgH1RFVCW, grandAvgH1RFVCCW, grandAvgLFVCW, grandAvgLFVCCW, grandCON,  grandAvgLowerBulge, grandAvgUpperBulge, grandAvgLowerLRO, grandAvgUpperLRO, grandAvgRRO,  grandAvgLowerDEP, grandAvgUpperDEP };
                ...
                if (QualityReportTBMWise.Checked)
                {
                    performanceAvgReportMainGridView.DataSource = gridviewdt;
        ...
        private void fillData(string wcName)
        {
            ...
            if (wcName == "30-352" || wcName == "30-353" || wcName == "30-354")
            {
                if (wcName == "30-352")
                    ...
                    dynamicWcname = "6306";
                dymamicquery = "Select  tireType ,LowerBulge, UpperBulge, LowerLRO, UpperLRO, RRO, LowerDepression, UpperDepression, GradeLowerBulge, GradeUpperBulge, GradeLowerLRO, GradeUpperLRO, GradeRRO, GradeLowerDepression, GradeUpperDepression FROM  vproductionDataPCRDBNew  WHERE wcname='" + dynamicWcname + "' and  ((testTime>" + dtnadtime;
                try
                {
                    myConnection.open(ConnectionOption.SQL);
                    myConnection.comm = myConnection.conn.CreateCommand();
            ...
            for (int i = 0; i < uniqrecipedt.Rows.Count; i++)
            {
                ...
                if (grade != "AllChecked" && grade != "SelectGrade")
                {
                    ...
                    if (wcName == "30-352" || wcName == "30-353" || wcName == "30-354")
                    {
                        ...
                        AvgLowerBulge = validateDT(dynamicdt, "LowerBulge", uniqrecipedt, i, ("GradeLowerBulge='" + tempgrade + "'"));
                        AvgUpperBulge = validateDT(dynamicdt, "UpperBulge", uniqrecipedt, i, ("GradeUpperBulge='" + tempgrade + "'"));
                        AvgLowerLRO = validateDT(dynamicdt, "LowerLRO", uniqrecipedt, i, ("GradeLowerLRO='" + tempgrade + "'"));
                        AvgUpperLRO = validateDT(dynamicdt, "UpperLRO", uniqrecipedt, i, ("GradeUpperLRO='" + tempgrade + "'"));
                        AvgRRO = validateDT(dynamicdt, "RRO", uniqrecipedt, i, ("GradeRRO='" + tempgrade + "'"));
                        AvgLowerDEP = validateDT(dynamicdt, "LowerDepression", uniqrecipedt, i, ("GradeLowerDepression='" + tempgrade + "'"));
                        AvgUpperDEP = validateDT(dynamicdt, "UpperDepression", uniqrecipedt, i, ("GradeUpperDepression='" + tempgrade + "'"));
                ...
                else if (grade == "AllChecked")
                {
                    ...
                    if (wcName == "30-352" || wcName == "30-353" || wcName == "30-354")
                    {
                        ...
                        AvgLowerBulge = validateDT(dynamicdt, "LowerBulge", uniqrecipedt, i, (""));
                        AvgUpperBulge = validateDT(dynamicdt, "UpperBulge", uniqrecipedt, i, (""));
                        AvgLowerLRO = validateDT(dynamicdt, "LowerLRO", uniqrecipedt, i, (""));
                        AvgUpperLRO = validateDT(dynamicdt, "UpperLRO", uniqrecipedt, i, (""));
                        AvgRRO = validateDT(dynamicdt, "RRO", uniqrecipedt, i, (""));
                        AvgLowerDEP = validateDT(dynamicdt, "LowerDepression", uniqrecipedt, i, (""));
                        AvgUpperDEP = validateDT(dynamicdt, "UpperDepression", uniqrecipedt, i, (""));
                    }
                    else
                    {
                ...
                dr[2] = gradetotal.ToString();
                dr[3] = gradeA.ToString();
                dr[4] = gradeB.ToString();
                dr[5] = gradeC.ToString();
                dr[6] = gradeD.ToString();
                dr[7] = gradeE.ToString();
                dr[8] = AvgRFVCW.ToString();
                dr[9] = AvgRFVCCW.ToString();
                dr[10] = AvgH1RFVCW.ToString();
                dr[11] = AvgH1RFVCCW.ToString();
                dr[12] = AvgLFVCW.ToString();
                dr[13] = AvgLFVCCW.ToString();
                dr[14] = CON.ToString();
                dr[15] = AvgLowerBulge.ToString();
                dr[16] = AvgUpperBulge.ToString();
                dr[17] = AvgLowerLRO.ToString();
                dr[18] = AvgUpperLRO.ToString();
                dr[19] = AvgRRO.ToString();
                dr[20] = AvgLowerDEP.ToString();
                dr[21] = AvgUpperDEP.ToString();
            ...
            tdr[13] = AvgLFVCCW_;
            tdr[14] = CON_;
            tdr[15] = AvgLowerBulge_;
            tdr[16] = AvgUpperBulge_;
            tdr[17] = AvgLowerLRO_;
            tdr[18] = AvgUpperLRO_;
            tdr[19] = AvgRRO_;
            tdr[20] = AvgUpperDEP_;
        ...
        private void showReportRecipeWise(GridView childgridview, string wcName, string rtodate, string rfromdate)
        {
            ...
            dymamicquery = "Select  tireType , LowerBulge, UpperBulge, LowerLRO, UpperLRO, RRO, LowerDepression, UpperDepression,GradeLowerBulge, GradeUpperBulge, GradeLowerLRO, GradeUpperLRO, GradeRRO, GradeLowerDepression, GradeUpperDepression FROM  vproductionDataPCRDBNew  WHERE  ((testTime>" + dtnadtime;
            try
            {
                myConnection.open(ConnectionOption.SQL);
                myConnection.comm = myConnection.conn.CreateCommand();
            ...
            for (int i = 0; i < uniqrecipedt.Rows.Count; i++)
            {
                ...
                if (grade != "AllChecked" && grade != "SelectGrade")
                {
                    ...
                    AvgLowerBulge = validateDT(dt, "LowerBulge", uniqrecipedt, i, ("GradeLowerBulge='" + grade + "'"));
                    AvgLowerBulge = AvgLowerBulge + validateDT(dynamicdt, "LowerBulge", uniqrecipedt, i, ("GradeLowerBulge='" + tempgrade + "'"));
                    AvgUpperBulge = validateDT(dt, "UpperBulge", uniqrecipedt, i, ("GradeUpperBulge='" + grade + "'"));
                    AvgUpperBulge = AvgUpperBulge + validateDT(dynamicdt, "UpperBulge", uniqrecipedt, i, ("GradeUpperBulge='" + tempgrade + "'"));
                    AvgLowerLRO = validateDT(dt, "LowerLRO", uniqrecipedt, i, ("GradeLowerLRO='" + grade + "'"));
                    AvgLowerLRO = AvgLowerLRO + validateDT(dynamicdt, "LowerLRO", uniqrecipedt, i, ("GradeLowerLRO='" + tempgrade + "'"));
                    AvgUpperLRO = validateDT(dt, "UpperLRO", uniqrecipedt, i, ("GradeUpperLRO='" + grade + "'"));
                    AvgUpperLRO = AvgUpperLRO + validateDT(dynamicdt, "UpperLRO", uniqrecipedt, i, ("GradeUpperLRO='" + tempgrade + "'"));
                    AvgRRO = validateDT(dt, "RRO", uniqrecipedt, i, ("GradeRRO='" + grade + "'"));
                    AvgRRO = AvgRRO + validateDT(dynamicdt, "RRO", uniqrecipedt, i, ("GradeRRO='" + tempgrade + "'"));
                    AvgLowerDEP = validateDT(dt, "LowerDepression", uniqrecipedt, i, ("GradeLowerDepression='" + grade + "'"));
                    AvgLowerDEP = AvgLowerDEP + validateDT(dynamicdt, "LowerDepression", uniqrecipedt, i, ("GradeLowerDepression='" + tempgrade + "'"));
                    AvgUpperDEP = validateDT(dt, "UpperDepression", uniqrecipedt, i, ("GradeUpperDepression='" + grade + "'"));
                    AvgUpperDEP = AvgUpperDEP + validateDT(dynamicdt, "UpperDepression", uniqrecipedt, i, ("GradeUpperDepression='" + tempgrade + "'"));
                }
                else if (grade == "AllChecked")
                {
                    AvgRFVCW = validateDT(dt, "RFVCW", uniqrecipedt, i, (""));
                    ...
                    AvgLowerBulge = validateDT(dt, "LowerBulge", uniqrecipedt, i, (""));
                    AvgLowerBulge = AvgLowerBulge + validateDT(dynamicdt, "LowerBulge", uniqrecipedt, i, (""));
                    AvgUpperBulge = validateDT(dt, "UpperBulge", uniqrecipedt, i, (""));
                    AvgUpperBulge = AvgUpperBulge + validateDT(dynamicdt, "UpperBulge", uniqrecipedt, i, (""));
                    AvgLowerLRO = validateDT(dt, "LowerLRO", uniqrecipedt, i, (""));
                    AvgLowerLRO = AvgLowerLRO + validateDT(dynamicdt, "LowerLRO", uniqrecipedt, i, (""));
                    AvgUpperLRO = validateDT(dt, "UpperLRO", uniqrecipedt, i, (""));
                    AvgUpperLRO = AvgUpperLRO + validateDT(dynamicdt, "UpperLRO", uniqrecipedt, i, (""));
                    AvgRRO = validateDT(dt, "RRO", uniqrecipedt, i, (""));
                    AvgRRO = AvgRRO + validateDT(dynamicdt, "RRO", uniqrecipedt, i, (""));
                    AvgLowerDEP = validateDT(dt, "LowerDepression", uniqrecipedt, i, (""));
                    AvgLowerDEP = AvgLowerDEP + validateDT(dynamicdt, "LowerDepression", uniqrecipedt, i, (""));
                    AvgUpperDEP = validateDT(dt, "UpperDepression", uniqrecipedt, i, (""));
                    AvgUpperDEP = AvgUpperDEP + validateDT(dynamicdt, "UpperDepression", uniqrecipedt, i, (""));
                }
                gradetotal_ += gradetotal;
                gradeA_ += gradeA;
                gradeB_ += gradeB;
        ...
        private string formatToDate(int day, int month, int year)
        {
            ...
            else if (DateTime.DaysInMonth(year, month) == day)
        ...
        {
            DataTable dt = performanceAvgReportMainGridView.DataSource as DataTable;
            Response.Clear();
            Response.ClearHeaders();
            Response.ClearContent();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=TUOReport3.xls");
            ...
            /*Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=PerformanceReportwithaverageDetail" + DateTime.Now.ToString("yyyy_MM_ddThh_mm_ss_") + ".xls");
           Response.Charset = "";
           ...
           if (QualityReportTBMWise.Checked)
           {
               ...
               performanceAvgReportMainPanel.Visible = true;
               productionReport2RecipeWiseMainPanel.Visible = false;
               form.Controls.Add(performanceAvgReportMainPanel);
        ...
        protected void OnDataBound(object sender, EventArgs e)
        {
            try
            {
                ...
                if (performanceAvgReportMainGridView.Rows.Count != 0)
                {
                ...
                if (performanceAvgReportTBMRecipeWiseMainGridView.Rows.Count != 0 || performanceAvgReportMainGridView.Rows.Count != 0)
                {
                    cell = new TableHeaderCell();
                    cell.Text = "";
                    row.Controls.Add(cell);
                    ...
                    cell = new TableHeaderCell();
                    cell.Text = "Average of selected parameter ";
                    cell.ColumnSpan = 14;
                    row.Controls.Add(cell);
                ...
                if (performanceAvgReportTBMRecipeWiseMainGridView.Rows.Count != 0)
                {
                    performanceAvgReportTBMRecipeWiseMainGridView.HeaderRow.Parent.Controls.AddAt(0, row);
                }
                if (performanceAvgReportMainGridView.Rows.Count != 0)
                {
                    performanceAvgReportMainGridView.HeaderRow.Parent.Controls.AddAt(0, row);
                }
            }
            catch (Exception exp)
            {
