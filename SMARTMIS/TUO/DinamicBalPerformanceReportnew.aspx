...
<asp:Panel ID="dinamicBalReportRecipeWisePanel" runat="server" ScrollBars="Horizontal" Height="100%" CssClass="panel" >
 <table class="innerTable" cellspacing="1" style="width:100%;">
        <tr>
            ...
            <td class="gridViewHeader" style="text-align:left; padding:5px" colspan="3"></td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" colspan="3">Rep</td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" colspan="3">Rejection</td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" rowspan="3">Rejection Details</td>
        </tr>
        <tr>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">A</td>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">B</td>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">C</td>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">D</td>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">E</td>
        </tr>
        <tr>
 ...
 <asp:GridView ID="dinamicBalMainRecipeWiseGridView" runat="server" AutoGenerateColumns="False"
    ...
    <RowStyle BackColor="#FCFCFC" ForeColor="#333333" />
        <Columns>
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="6%" ItemStyle-Wrap=true>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="92%">
                <ItemTemplate>
                    ...
                    <asp:GridView ID="DinamicBalRecipeWiseChildGridView" runat="server" AutoGenerateColumns="False" 
                        ...
                        <RowStyle BackColor="#FFFFFF" ForeColor="#333333" />
                            <Columns>
                                <asp:TemplateField HeaderText="WcName" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="1%" Visible="false">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="8%" ItemStyle-Wrap="true">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="A Grade" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="B Grade" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="C Grade" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="D Grade" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="E Grade" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Rejection Details" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="1%">
                                    <ItemTemplate>
  ...
  <asp:Panel ID="RecipeWisePanel" runat="server" ScrollBars="Both" Width="100%" CssClass="panel" Visible="false" >

 <table class="innerTable" cellspacing="1" style="width:100%;">
        <tr>
            <td class="gridViewHeader" style="width:12%; text-align:left; padding:5px" 
                rowspan="3">Tyre Type</td>
            <td class="gridViewHeader" style="width:10%; text-align:center; padding:5px" 
                rowspan="3">Checked</td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" colspan="6">OE</td>
            <td class="gridViewHeader" style="text-align:left; padding:5px" colspan="3"></td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" colspan="3">Rep</td>
            <td class="gridViewHeader" style="text-align:center; padding:5px" colspan="3">Rejection</td>
            <td class="gridViewHeader" style=" width:3%; text-align:center; padding:5px" rowspan="3">VIEW</td>
             <td class="gridViewHeader" style=" width:1%; text-align:center; padding:5px" rowspan="3"></td>
        </tr>
        <tr>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">A</td>
            <td class="gridViewAlternateHeader" style="width:15%; text-align:center; padding:5px" colspan="3">B</td>
...
<asp:Panel ID="RecipeWisePanel1" runat="server" ScrollBars="Both" Height="500PX" CssClass="panel" Visible="true" >

           <asp:GridView ID="DinamicBalRecipeWiseGridView" runat="server" 
        AutoGenerateColumns="False" RowStyle-CssClass="rowHover" 
                        Width="100%" CellPadding="3" ForeColor="#333333" 
        GridLines="both" onrowdatabound="GridView_RowDataBound"
                        AllowPaging="false" AllowSorting="false" PageSize="5" 
        ShowHeader="false" >
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                        <RowStyle BackColor="#FFFFFF" ForeColor="#333333" />
                            <Columns>
                                <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="Left" ItemStyle-Width="12%" ItemStyle-Wrap="true">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalSizeWiseTyreTypeLabel" runat="server"
                                                Text='<%# Eval("tireType") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                    
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="Checked" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseCheckedLabel" runat="server" 
                                                Text='<%# Eval("Checked") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="A Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalecipeWiseUpperAGradeLabel" runat="server" 
                                                Text='<%# Eval("UpperA") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="A Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalecipeWiseLowerAGradeLabel" runat="server" 
                                                Text='<%# Eval("LowerA") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="A Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalecipeWiseStaticAGradeLabel" runat="server" 
                                                Text='<%# Eval("StaticA") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="B Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseUpperBGradeLabel" runat="server" 
                                                Text='<%# Eval("UpperB") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="B Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseLowerBGradeLabel" runat="server" 
                                                Text='<%# Eval("LowerB") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="B Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseStaticBGradeLabel" runat="server" 
                                                Text='<%# Eval("StaticB") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="C Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseUpperCGradeLabel" runat="server" 
                                                Text='<%# Eval("UpperC") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="C Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseLowerCGradeLabel" runat="server" 
                                                Text='<%# Eval("LowerC") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="C Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseStaticCGradeLabel" runat="server" 
                                                Text='<%# Eval("StaticC") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="D Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseUpperDGradeLabel" runat="server" 
                                                Text='<%# Eval("UpperD") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="D Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseLowerDGradeLabel" runat="server" 
                                                Text='<%# Eval("LowerD") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="D Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center"  ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseStaticDGradeLabel" runat="server" 
                                                Text='<%# Eval("StaticD") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="E Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseUpperEGradeLabel" runat="server" 
                                                Text='<%# Eval("UpperE") %>' CssClass="gridViewItems"></asp:Label>
                                   </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="E Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseLowerEGradeLabel" runat="server" 
                                                Text='<%# Eval("LowerE") %>' CssClass="gridViewItems"></asp:Label>
                                   </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="E Grade" HeaderStyle-CssClass="gridViewHeader" 
                                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                            <asp:Label ID="dinamicBalRecipeWiseStaticEGradeLabel" runat="server" 
                                                Text='<%# Eval("StaticE") %>' CssClass="gridViewItems"></asp:Label>
                                   </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                                <asp:TemplateField HeaderText="Rejection Details" 
                                     ItemStyle-HorizontalAlign="center"
                                    ItemStyle-Width="3%">
                                    <ItemTemplate>
                                        <asp:Button ID="RejectionDetailsRecipeWise"  runat="server" Text="vw" CssClass="gridViewItems" OnClick="viewDetails_Click" ToolTip="View Rejection Details" />
                                   </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        <PagerStyle BackColor="#507CD1" ForeColor="White" 
