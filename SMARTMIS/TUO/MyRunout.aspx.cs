...
{
    public partial class MyRunout : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                switch (DropDownListDuration.SelectedItem.Value)
                {
                    case "Date":
                        ...
                        fromDate = Convert.ToDateTime(formatDate(getfromdate), System.Globalization.CultureInfo.InvariantCulture);
                        toDate = fromDate.AddDays(1);
                        string nfromDate = formatDate(reportMasterFromDateTextBox.Text);//fromDate.ToString("dd/MMM/yyyy") + " 07:00:00";
                        toDate = DateTime.Parse(nfromDate, System.Globalization.CultureInfo.InvariantCulture);
        ...
        {
            //nfromDate = "04-18-2020 07:00:00";
            //ntoDate = "04-19-2020 07:00:00";
            try
            {
