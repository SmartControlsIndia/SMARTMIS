<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="RunoutBarcodeWiseReport.aspx.cs" Inherits="SmartMIS.TUO.RunoutBarcodeWiseReport" Title="SMARTMIS" EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>RUNOUT BarCode Wise Report</h2></td>
...
<asp:Label ID="ShowWarning" runat="server" Text="" CssClass="alrtPopup" Visible="false"></asp:Label>
 ...
 <tr>    
      ...
      <asp:Button ID="ViewButton" runat="server" CausesValidation="false" Text="View Report" onclick="ViewButton_Click"/>&nbsp;</td>             
       ...
       <td style="font-weight:bold; font-family:Arial; font-size:small; width:10%"> select Machine &nbsp; ::</td>       
       <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">          
       <asp:DropDownList ID="GradeDropDownList" Width="100%" runat="server" AutoPostBack="false">
                   <asp:ListItem Value="ALL">ALL</asp:ListItem>
                   <asp:ListItem Value="TRO1">TRO1</asp:ListItem>
                   <asp:ListItem Value="TRO2">TRO2</asp:ListItem>
                   <asp:ListItem Value="TRO3">TRO3</asp:ListItem>
                   <asp:ListItem Value="TRO4">TRO4</asp:ListItem>
                  
        </asp:DropDownList>
       </td> <td style="font-weight:bold; font-family:Arial; font-size:small; width:10%">&nbsp; </td>
