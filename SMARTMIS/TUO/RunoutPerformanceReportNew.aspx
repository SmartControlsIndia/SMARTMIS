<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RunoutPerformanceReportNew.aspx.cs" MasterPageFile="~/NewTUOReportMaster.Master" Inherits="SmartMIS.TUO.RunoutPerformanceReportNew" %>
...
<asp:Label ID="showDownload" runat="server" Text=""></asp:Label>
 ...
 <td colspan="14" style="font-weight:bold; font-family:Arial; font-size:large; color:White;">RUNOUT PERFORMANCE REPORT FOR TRO1</td>
 </tr>
    <tr>
