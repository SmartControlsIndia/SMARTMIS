<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="TBRUniformityReport.aspx.cs" Inherits="SmartMIS.Report.TBRUniformityReport" Title="Uniformity Report" %>
...
<td class="tablecolumn" >
    <asp:DropDownList ID="ddlMachineType" runat="server" Width="100%" CssClass="dropdown" >
       <asp:ListItem Value="2">Uniformity</asp:ListItem>
        <asp:ListItem Value="1">TBM</asp:ListItem>
...
<td width="25%" ><span class="masterLabel" style="padding-left: 5px; cursor:pointer;" onclick="toggleduration();">Duration :</span>
 ...
 <td class="tablecolumn">Shift :
    <asp:DropDownList ID="ddlshift" runat="server" Width="50%" CssClass="dropdown" >
   ...
   <%-- <script src="../js/jquery.min.js" type="text/javascript"></script>
                                                      ...
                                                      <script src="../js/bootstrap-multiselect.js" type="text/javascript"></script>
                                                        ...
                                                        <script type="text/javascript">
                                                            $(function() {
                                                            $('[id*=lstMachineProcess]').multiselect({
