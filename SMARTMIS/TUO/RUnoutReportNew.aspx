<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/smartMISMaster.Master" CodeBehind="RUnoutReportNew.aspx.cs" Inherits="SmartMIS.TUO.RUnoutReportNew" Title="SMARTMIS" %>
...
<asp:Label ID="ShowWarning" runat="server" Text="" CssClass="alrtPopup" Visible="false"></asp:Label>
 ...
 <tr>    
      ...
      <asp:Button ID="ViewButton" runat="server" CausesValidation="false" Text="View Report" onclick="ViewButton_Click" style="    margin-left: -220px;"/>&nbsp;</td>             
          
       <td style="font-weight:bold; font-family:Arial; font-size:small; width:10%"> select Machine &nbsp; ::</td>       
       <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">          
       <asp:DropDownList ID="GradeDropDownList" Width="100%" runat="server" AutoPostBack="true" >
