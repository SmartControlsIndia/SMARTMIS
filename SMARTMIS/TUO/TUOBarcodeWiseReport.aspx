...
<asp:Label ID="ShowWarning" runat="server" Text="" CssClass="alrtPopup" Visible="false"></asp:Label>
 <table cellpadding="0" cellspacing="0" style="width: 100%; border-style:solid; border-width:thin; border-color: #507CD1; background-color: #FFFFFF;" align="center">
  <div id="RadiobuttonDiv" runat="server" style="text-align:center; border-width:thin; border-style:solid">  
     <asp:RadioButton ID="BarcodeFromTOWiseReport" Text="BarcodeFromTUOWiseReport" 
          GroupName="BarcodeReport" Checked="true" runat="server" 
          oncheckedchanged="BarcodeFromTUOWiseReport_CheckedChanged" AutoPostBack="true" />
     <asp:RadioButton ID="DateFromToReport" Text=" DateFromToWiseReport" GroupName="barcodeReport"
         runat="server"  oncheckedchanged="BarcodeFromTUOWiseReport_CheckedChanged" AutoPostBack="true" /> </div>
 ...
 <tr>    
      ...
      <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">         
       <asp:DropDownList ID="MachineDropDownList" Width="100%" runat="server" AutoPostBack="true" onselectedindexchanged="FaultTypeDropDownList_SelectedIndexChanged">
                   ...
                   <asp:ListItem>30-349</asp:ListItem>
                   <asp:ListItem>30-350</asp:ListItem>
                   <asp:ListItem>30-351</asp:ListItem>
                   <asp:ListItem>30-352</asp:ListItem>
                   <asp:ListItem>30-353</asp:ListItem>
                   <asp:ListItem>30-354</asp:ListItem>
               </asp:DropDownList>            
       </td>   
       <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%"> Tyre Type &nbsp; ::</td>      
      <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">         
         <asp:DropDownList ID="ddlRecipe" Width="100%" runat="server" AutoPostBack="true" onselectedindexchanged="FaultTypeDropDownList_SelectedIndexChanged">
