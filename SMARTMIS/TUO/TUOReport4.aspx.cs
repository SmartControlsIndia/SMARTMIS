...
namespace SmartMIS.TUO
{
    public partial class TUOReport4 : System.Web.UI.Page
    {
        ...
        protected void magicButton_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            excelquery.Text = query.ToString();
            ...
            if (tempString2[1] != "0")
            {
                ...
                {
                    rType = "dayWise";
                    excelToDate.Text = rToDate = myWebService.formatDate(tempString2[3]);
                    excelFromDate.Text = rFromDate = myWebService.formatDate(tempString2[4]);
                ...
                {                    
                    showReportRecipeWise(MainGridView, "", rToDate, rFromDate);
                }
        ...
        protected void GridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {                
               ...
               {
                    Label cell;
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpecCheckedLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpecAGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpecBGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpec10GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpec20GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpec30GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportTBMWiseSpecmorethan30GradeLabel"));
                    cell.Text = NullIf(cell.Text);

                }
                if (((GridView)sender).ID == "performanceReportRecipeWiseSpecGridView")
                {
                    Label cell;
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpecCheckedLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpecAGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpecBGradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpec10GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpec20GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpec30GradeLabel"));
                    cell.Text = NullIf(cell.Text);
                    cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseSpecmorethan30GradeLabel"));
                    cell.Text = NullIf(cell.Text);
        ...
        private void showReport(string query)
        {
            try
            {
                ...
                dr[0] = "Grand Total";
                dr[1] = "";
                double[] last_row = new double[] { grandtotal, grandA, grandB, grandspecPlus10, grandSpecPlus20, grandSpecPlus30, grandSpecGreaterThan30 };
    ...
    .Where(row => row.Cells[1].Text == "Total" || row.Cells[0].Text == "Grand Total");
                ...
                for(int i = 0; i < MainGridView.Rows.Count; i++ )
                {
                    ...
                    {
                        MainGridView.Rows[i].Cells[j].Text = NullIf(MainGridView.Rows[i].Cells[j].Text);
                    }
                }
            }
            catch (Exception exp)
        ...
        private void fillData(string wcName)
        {
            ...
            for (int i = 0; i < uniqrecipedt.Rows.Count; i++)
            {
                ...
                switch (option)
                {
                    case "1":
                        ...
                        dr[3] = A.ToString();
                        dr[4] = B.ToString();
                        dr[5] = specPlus10.ToString();
                        dr[6] = SpecPlus20.ToString();
                        dr[7] = SpecPlus30.ToString();
                        dr[8] = SpecGreaterThan30.ToString();
                        break;
                    case "2":
                        ...
                        dr[5] = Math.Round(pspecPlus10, 1) + "%";
                        dr[6] = Math.Round(pSpecPlus20, 1) + "%";
                        dr[7] = Math.Round(pSpecPlus30, 1) + "%";
                        dr[8] = Math.Round(pSpecGreaterThan30, 1) + "%";
                        break;
                }
                gridviewdt.Rows.Add(dr);
            }
            ...
            switch (option)
            {
                ...
                case "2":
                    ...
                    tdr[5] = Math.Round(pspecPlus10_, 1) + "%";
                    tdr[6] = Math.Round(pSpecPlus20_, 1) + "%";
                    tdr[7] = Math.Round(pSpecPlus30_, 1) + "%";
                    tdr[8] = Math.Round(pSpecGreaterThan30_, 1) + "%";
                    break;
            }
