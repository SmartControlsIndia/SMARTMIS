...
namespace SmartMIS.TUO
{
       ...
       protected void Button_Click(object sender, EventArgs e)
       {
            try
            {
                ...
                if (((Button)sender).ID == "ErankViewDetailButton")
                {
                    ...
                    string wcname = (((Label)gridViewRow.Cells[1].FindControl("performanceReportSizeWiseWCNameLabel")).Text);
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    if (((GridView)sender).ID == "performanceReportSizeWiseMainGridView")
                    {
                        ...
                        for (int rowIndex = performanceReportSizeWiseMainGridView.Rows.Count - 2; rowIndex >= 0; rowIndex--)
                {
                    GridViewRow gvRow = performanceReportSizeWiseMainGridView.Rows[rowIndex];
                    GridViewRow gvPreviousRow = performanceReportSizeWiseMainGridView.Rows[rowIndex + 1];
                    if (((Label)performanceReportSizeWiseMainGridView.Rows[rowIndex].FindControl("performanceReportSizeWiseWCNameLabel")).Text == ((Label)performanceReportSizeWiseMainGridView.Rows[rowIndex + 1].FindControl("performanceReportSizeWiseWCNameLabel")).Text)
                    {
                        ...
                        if (((Label)e.Row.FindControl("performanceReportSizeWiseWCNameLabel")).Text == "Grand Total" || ((Label)e.Row.FindControl("performanceReportSizeWiseTyreTypeLabel")).Text == "Total")
                    {
                        ...
                        Label cell;
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseCheckedLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseAGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseBGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseCGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseDGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportSizeWiseEGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        
                    }
                    if (((GridView)sender).ID == "performanceReportrecipeWiseChildGridView")
                    {
                        Label cell;
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseCheckedLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseAGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseBGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseCGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseDGradeLabel"));
                        cell.Text = NullIf(cell.Text);
                        cell = ((Label)e.Row.FindControl("performanceReportRecipeWiseEGradeLabel"));
                        cell.Text = NullIf(cell.Text);
       ...
       private void showReportRecipeWise(GridView childgridview, string wcName, string rtodate, string rfromdate)
       {
          ...
          // DataTable gridviewdt = new DataTable();
           ...
           else if(QualityReportRecipeWise.Checked)
           {
               ...
               IEnumerable<GridViewRow> rows = performanceReportrecipeWiseChildGridView.Rows.Cast<GridViewRow>()
   .Where(row => row.Cells[0].Text == "Total");
           ...
           ViewState["TUOReport2"] = gridviewdt;
       }
       ...
       private void showReport(string query)
       {
           try
           {
               ...
               dr[0] = "Grand Total";
               dr[1] = "";
               double[] last_row = new double[] { grandtotal, grandA, grandB, grandC, grandD, grandE };
               ...
               if (QualityReportTBMWise.Checked)
               {
                   performanceReportSizeWiseMainGridView.DataSource = gridviewdt;
                   performanceReportSizeWiseMainGridView.DataBind();
               }
           }
           catch (Exception exp)
       ...
       {
           DataTable dt =(DataTable)ViewState["TUOReport2"];
           try
           {
               Response.Clear();
               ...
               Response.AddHeader("content-disposition", "attachment;filename=TUOReport2.xls");
               Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";

               ExcelPackage pck = new ExcelPackage();
               ExcelWorksheet ws = pck.Workbook.Worksheets.Add("TUOReport2");
               ws.Cells["A1"].LoadFromDataTable((DataTable)ViewState["TUOReport2"], true, OfficeOpenXml.Table.TableStyles.Medium2);
       ...
       protected void OnDataBound(object sender, EventArgs e)
       {
           /*try
           {
               ...
               if (performanceReportSizeWiseMainGridView.Rows.Count != 0)
               {
               ...
               if (performanceReportrecipeWiseChildGridView.Rows.Count != 0 || performanceReportSizeWiseMainGridView.Rows.Count != 0)
               {
                   cell = new TableHeaderCell();
                   cell.Text = "";
                   cell.ColumnSpan = 1;
                   ...
                   if (performanceReportrecipeWiseChildGridView.Rows.Count != 0)
                   {
                       performanceReportrecipeWiseChildGridView.HeaderRow.Parent.Controls.AddAt(0, row);
                   }
                   if (performanceReportSizeWiseMainGridView.Rows.Count != 0)
                   {
                       performanceReportSizeWiseMainGridView.HeaderRow.Parent.Controls.AddAt(0, row);
                   }
               }
           }
           catch (Exception exp)
