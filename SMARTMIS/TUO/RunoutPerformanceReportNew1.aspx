<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RunoutPerformanceReportNew1.aspx.cs" MasterPageFile="~/NewTUOReportMaster.Master" Inherits="SmartMIS.TUO.RunoutPerformanceReportNew1" %>
...
<asp:Label ID="showDownload" runat="server" Text=""></asp:Label>
 ...
 <td colspan="14" style="font-weight:bold; font-family:Arial; font-size:large; color:White;">RUNOUT PERFORMANCE REPORT FOR TRO2 ,TRO3,TRO4 </td>
 </tr>
    <tr>
