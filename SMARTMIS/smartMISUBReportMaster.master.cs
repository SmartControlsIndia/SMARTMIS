...
namespace SmartMIS
{
    public partial class smartMISUBReportMaster : System.Web.UI.MasterPage
    {
        ...
        private void fillProcessDropDownList()
        {
            ...
            tuoReportMasterWCProcessDropDownList.DataSource = myWebService.FillDropDownList("processMaster", "name", "where iD=19");
