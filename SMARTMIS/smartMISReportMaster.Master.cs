...
namespace SmartMIS
{
    public partial class smartMISReportMaster : System.Web.UI.MasterPage
    {
        ...
        #region User Defined Function
            ...
            {
                string processCondition = string.IsNullOrEmpty(processName) ? "" : " WHERE processID='" + processName + "'";
                TBMProductionReportSizeDropdownlist.Items.Clear();
                TBMProductionReportSizeDropdownlist.DataSource = null;
                TBMProductionReportSizeDropdownlist.DataSource = FillDropDownList("vProductionActual1 " + processCondition, "recipeName");
                TBMProductionReportSizeDropdownlist.DataBind();
            }
