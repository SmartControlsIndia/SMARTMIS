...
function handleSearchSuggest()
 ...
 {	
   ...
   div_value.className = 'suggest_link_over';
   document.getElementById('ctl00_masterContentPlaceHolder_productionPlanningRecipeCodeTextBox').value = div_value.innerHTML;
 }
 ...
 function setSearch(value) 
 {
    ...
    document.getElementById('ctl00_masterContentPlaceHolder_productionPlanningRecipeCodeTextBox').value = value;	
    ss.innerHTML = '';
    ss.style.visibility='hidden';
 }
    ...
    if(key==40)
    {
         ...
         else
         {
            if(currentDivId==maxDivId)
            {
                 ...
                 currentDivId=-1;
                 suggestOut(a)
                 document.getElementById('ctl00_masterContentPlaceHolder_productionPlanningRecipeCodeTextBox').value = strOriginal;
            }
            else
            {
