...
namespace SmartMIS
{
    public partial class smartMISTBMmanualproductionReport : System.Web.UI.MasterPage
    {
        ...
        private void fillProcessDropDownList()
        {
            ...
            dt1.Rows.Add("tbmtbr11", "TBMTBR");
            dt1.Rows.Add("tbmpcr12", "TBMPCR");

            // reportMasterWCProcessDropDownList.DataSource = myWebService.FillDropDownList("processMaster", "name");
            reportMasterWCProcessDropDownList.DataSource = dt1;//myWebService.FillDropDownList("processMaster", "name", "where iD in (28,29) ");
            reportMasterWCProcessDropDownList.DataTextField = "Name";
            reportMasterWCProcessDropDownList.DataValueField = "id";
        ...
        protected void DropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                fillWCGridView(Page.Title.Trim(), ((DropDownList)sender).SelectedItem.Value.ToString()); // old .SelectedItem.ToString());
                reportMasterWCAllCheckBox.Checked = false;

                if (reportMasterWCProcessDropDownList.SelectedValue == "tbmpcr12")
                    processName = "29";  //Building PCR
                else if (reportMasterWCProcessDropDownList.SelectedValue == "tbmtbr11")
                    processName = "28";  //Building TBR
        ...
        protected void Export_click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=TBM_Manual_Production_Report" + DateTime.Now.ToString("yyyy_MM_ddThh_mm_ss_") + ".xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.xls";
            System.IO.StringWriter stringWrite = new System.IO.StringWriter();
            System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
            stringWrite.Write("<table><tr><td><b>TBM Manual Production Report</b></td><td>" + getTimeDuration + "</td><td><b>Type :</b> " + type + "</td><td><b>" + reportMasterWCProcessDropDownList.SelectedItem.Value + "</b></td></tr></table>");
