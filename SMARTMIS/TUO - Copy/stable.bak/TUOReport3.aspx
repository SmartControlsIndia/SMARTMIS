<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TUOReport3.aspx.cs" MasterPageFile="~/smartMISTUOReportMaster.Master" Inherits="SmartMIS.TUO.TUOReport3" Title="Performance Report With Average Details" %>
...
<asp:Label ID="showDownload" runat="server" Text=""></asp:Label>
  ...
  <asp:Panel ID="performanceAvgReportMainPanel" runat="server" ScrollBars="Horizontal" Width="1097PX" Height="100%" CssClass="panel" >
...
<table class="innerTable" style="background-color:Gray; width:175%;">
    ...
    <asp:Panel ID="productionReport2RecipeWiseMainPanel" runat="server" ScrollBars="Horizontal" Width="1097PX" Height="100%" CssClass="panel" >
