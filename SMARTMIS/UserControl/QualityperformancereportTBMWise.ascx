<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QualityperformancereportTBMWise.ascx.cs" Inherits="SmartMIS.UserControl.QualityperformancereportTBMWise" %>
