...
{
    public partial class QualityPerformanceReportTBMRecipeWise : System.Web.UI.UserControl
    {
        #region classes
        ...
        public String Visiblity
        {
            ...
            get
            {
                return productionReport2RecipeWiseMainPanel.Style[HtmlTextWriterStyle.Display];
            }
            set
            {
                productionReport2RecipeWiseMainPanel.Style.Add(HtmlTextWriterStyle.Display, value);
            ...
            try
            {
                ...
                else
                {
                    ...
                    //Compare the hidden field if it contains the query string or not
                                ...
                                showReport(wcnamequery);
                                string footergrid = "performanceReport2TBMRecipeWiseFooterGridView";
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    if (((GridView)sender).ID == "performanceReport2TBMRecipeWiseMainGridView")
                    {
                        ...
                        fillChildInnerGridView(wcnamequery, childGridView, recipeCodeLabel.Text.Trim(), formattoDate(rToDate), formatfromDate(rToDate), "1");
                    }
        ...
        private void showReport(string query)
        {
            ...
            fillGridView("Select DISTINCT  tireType from vproductionDataTUO WHERE (" + query + ") and (testTime>'"+todate+"' and testTime<='"+fromdate+"')");
        ...
        private void fillChildInnerGridView(string wcname, GridView childGridView, string recipecode, String toDate, String fromDate, String option)
        {
            ...
            try
            {
                ...
                if (childGridView.ID == "performanceReport2TBMRecipeWiseChildGridView")
                {
                    if (option == "1")
                    {
        ...
        public DataTable fillGridView(string procedureName, string wcName, string recipeCode, string rToDate, string rFromDate, ConnectionOption option)
        {
            ...
            if (option == ConnectionOption.SQL)
            {
                try
                {
                    ...
                    System.Data.SqlClient.SqlParameter wcNameParameter = new System.Data.SqlClient.SqlParameter("@wcName", System.Data.SqlDbType.VarChar);
                    wcNameParameter.Direction = System.Data.ParameterDirection.Input;
                    wcNameParameter.Value = wcName;
                    ...
                    myConnection.comm.Parameters.Add(wcNameParameter);
        ...
        private void fillChildInnerGridView(string GridView, string recipecode, String toDate, String fromDate, String option)
        {
            ...
            {
                string dtnadtime = TotalformatDate(rToDate);
                if (GridView == "performanceReport2TBMRecipeWiseFooterGridView")
                {
                    if (option == "1")
                    {
