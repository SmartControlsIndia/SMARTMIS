<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recipe.aspx.cs" MasterPageFile="~/smartMISMaster.Master" MaintainScrollPositionOnPostback="true" Inherits="SmartMIS.Master.recipe" %>
            ...
            <table class="masterTable" align="center" cellpadding="0" cellspacing="0">
                   ...
                   <td class="masterLabel"> Process Name :</td>
                    <td class="masterTextBox">
                        <asp:DropDownList ID="recipeProcessNameDropDownList" runat="server" 
                            CssClass="masterDropDownList recipeProcessNameDropDownList" Width="82%" AutoPostBack="true"
                ...
                <tr>
                    <td class="masterLabel">
                        OEM Name :</td>
                    <td>
                        <asp:DropDownList ID="OEMDropDownList" runat="server" AutoPostBack="true" 
                ...
                <tr>
                    ...
                    <td class="masterTextBox">
                       <asp:DropDownList ID="DesignDropDownList1" runat="server" 
                            CssClass="masterDropDownList DesignDropDownList1" Width="82%" AutoPostBack="true" onselectedindexchanged="DropDownList_SelectedIndexChanged" >
                        </asp:DropDownList>
...
">
                ...
                $('.panel table td:nth-child(18)').addClass("hide");
                $('.panel table td:nth-child(19)').addClass("hide");
                $('.panel table td:nth-child(20)').addClass("hide");
