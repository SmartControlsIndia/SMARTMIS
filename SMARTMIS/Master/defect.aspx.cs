...
namespace SmartMIS
{
    public partial class defectStatus : System.Web.UI.Page
    {
        ...
        #region User Defined Function
            ...
            private void fillGridView()
            {
                ...
                //Description   : Function for filling defectGridView
                //Author        : Brajesh kumar
                //Date Created  : 28 March 2011
                //Date Updated  : 28 March 2011
                //Revision No.  : 01

                defectGridView.DataSource = myWebService.fillGridView("Select * from vdefectStatus", "iD", smartMISWebService.order.Desc);
            ...
            private int save()
            {
                //Description   : Function for saving and updating record in defectstatusMaster Table
                //Author        : Brajesh kumar
                //Date Created  : 28 March 2011
                //Date Updated  : 28 March 2011
                //Revision No.  : 01
                ...
                {
                    if ((validation() <= 0) && (myWebService.IsRecordExist("defectstatusMaster", "name", "where name='" + defectNameTextBox.Text.Trim() + "'", out notifyIcon) == false))
                    {
                        myConnection.open(ConnectionOption.SQL);
                        myConnection.comm = myConnection.conn.CreateCommand();

                        myConnection.comm.CommandText = "Insert into defectstatusMaster (name, description) values (@name, @description)";
                        ...
                        Notify(1, "Defect saved successfully");
                    }
                    else
                    {
                        Notify(notifyIcon, "Defect Name already exists");
                    }
                }
                else if (defectIDLabel.Text.Trim() != "0")
                {
                    if (validation() <= 0)
                    {
                        ...
                        myConnection.comm.CommandText = "Update defectstatusMaster SET name = @name, description = @description WHERE (iD = @iD)";
                        myConnection.comm.Parameters.AddWithValue("@name", defectNameTextBox.Text.Trim());
                        myConnection.comm.Parameters.AddWithValue("@description", defectDescriptionTextBox.Text.Trim());
                        ...
                        Notify(1, "Defect updated successfully");
                    }
                }
            ...
            private int delete()
            {
                ...
                //Description   : Function for deleting record in defectstatusMaster Table
                //Author        : Brajesh kumar
                //Date Created  : 28 March 2011
                //Date Updated  : 28 March 2011
                //Revision No.  : 01
                ...
                if (defectIDLabel.Text.Trim() != "0")
                {
                    ...
                    myConnection.comm.CommandText = "Delete From defectstatusMaster WHERE (iD = @iD)";
                    myConnection.comm.Parameters.AddWithValue("@iD", defectIDLabel.Text.Trim());
                    ...
                    Notify(1, "Defect deleted successfully");
                }
            ...
            private int validation()
            {
                ...
                //Description   : Function for validation of data for inserting and deleting record in defectstatusMaster Table
                //Author        : Brajesh kumar
                //Date Created  : 28 March 2011
                //Date Updated  : 28 March 2011
                //Revision No.  : 01
