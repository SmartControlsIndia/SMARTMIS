<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="defect.aspx.cs" MasterPageFile="~/smartMISMaster.Master" MaintainScrollPositionOnPostback="true" Inherits="SmartMIS.defectStatus" %>
        ...
        <ContentTemplate>
            <table class="masterTable" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="4">
                        <div class="masterHeader">
                            <p class="masterHeaderTagline">Defect Status</p>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="masterLabel">Defect Status Name :</td>
                    <td class="masterTextBox">
                        <asp:TextBox ID="defectNameTextBox" runat="server" AutoComplete="off" Width="80%"></asp:TextBox>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="defectNameReqFieldValidator" runat="server" CssClass="reqFieldValidator"
                            ControlToValidate="defectNameTextBox" ErrorMessage="defect Status Name is Required">
                                        ...
                                        <div class="modalBody">
                                            <table class="innerTable" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="defectMessageLabel" runat="server" CssClass="masterWelcomeLabel" Text="Do you want to delete Defect."></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                ...
                <tr>
                    <td colspan="4">
                        <div class="masterHeader">
                            <p class="masterHeaderTagline">Defect Status List</p>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        ...
                        <asp:Panel ID="defectPanel" runat="server" ScrollBars="Vertical" Height="195px" CssClass="panel" >
                            ...
                            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />                                   
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Defect Status Name" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%">
                                        <ItemTemplate>
