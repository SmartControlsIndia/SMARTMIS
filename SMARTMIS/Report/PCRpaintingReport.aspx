<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="PCRpaintingReport.aspx.cs" Inherits="SmartMIS.Report.PCRpaintingReport" Title="Untitled Page" %>
...
<table width="100%"><tr><td width="55%" align="center"><h2>PCR Painting Report</h2></td>
...
<asp:ScriptManager ID= "PCRpaintingScriptManager" AsyncPostBackTimeout="360000" runat="server"></asp:ScriptManager>
...
<asp:Panel ID="ReportMonthWisePanel" runat="server" ScrollBars="Both" Height="90%" CssClass="panel" >
