<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/smartMISMaster.Master" CodeBehind="BudhayTyreScanningReportNew.aspx.cs" Inherits="SmartMIS.Report.BudhayTyreScanningReportNew" %>
...
.ErrorMsgCSS
{
 ...
 <link rel="stylesheet" href="../Style/reportMaster.css" type="text/css" charset="utf-8" />
    ...
    <script type="text/javascript" language="javascript">
      ...
      <center><H2>TBR BUDDE EXIT STATION REPORT</H2></center> 
...
<asp:Label ID="ErrorMsg" runat="server" Text="" CssClass="ErrorMsgCSS" Visible="false"></asp:Label>
   ...
   <asp:Label ID="HeaderText" runat="server" Text=""></asp:Label>
    ...
    <asp:GridView Width="110%" CssClass="TBMTable" ID="MainGridView" OnDataBound = "OnDataBound" runat="server" AutoGenerateColumns="False" onrowdatabound="GridView_RowDataBound">
     <Columns>
