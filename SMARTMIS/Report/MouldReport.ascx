...
<asp:Panel ID="mouldReportDatewWiseMainPanel" runat="server" ScrollBars="None" Height="100%" CssClass="panel" Visible="true" >
    ...
    <table class="innerTable" cellspacing="1">
        <tr>
           ...
           <td class="gridViewHeader" style="width:14%; text-align:center; padding:5px" rowspan="2">CurrentMould Code </td>
           <td class="gridViewHeader" style="width:11%; text-align:center; padding:5px" rowspan="2">Current Mould Size</td>
