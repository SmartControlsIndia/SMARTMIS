<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="TbrPaintingReport.aspx.cs" Inherits="SmartMIS.Report.TbrPaintingReport" Title="Untitled Page" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>TBR PAINTING REPORT</h2></td>
        ...
        <td style="width: 45%">
         ...
         <myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" />
               ...
               <asp:ListItem Text="ALL">ALL</asp:ListItem>
                  <asp:ListItem Text="TBRPAINTING-1">TBRPAINTING-1</asp:ListItem>
                   <asp:ListItem Text="TBRPAINTING-2">TBRPAINTING-2</asp:ListItem>
               </asp:DropDownList>
