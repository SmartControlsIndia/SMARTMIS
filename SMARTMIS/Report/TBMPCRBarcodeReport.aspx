<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="TBMPCRBarcodeReport.aspx.cs" Inherits="SmartMIS.Report.TBMPCRBarcodeReport" Title="TBMPCRReport" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>TBM PCR REPORT</h2></td>
        ...
        <td style="width: 45%">
         ...
         <myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" />
               ...
               <asp:ListItem Text="ALL">ALL</asp:ListItem>
                   <asp:ListItem Text="3401">3401</asp:ListItem>
                   <asp:ListItem Text="3402">3402</asp:ListItem>
                   <asp:ListItem Text="3403">3403</asp:ListItem>
                   <asp:ListItem Text="3404">3404</asp:ListItem>
                   <asp:ListItem Text="3405">3405</asp:ListItem>
                   <asp:ListItem Text="3406">3406</asp:ListItem>
                   <asp:ListItem Text="3407">3407</asp:ListItem>
                   <asp:ListItem Text="3408">3408</asp:ListItem>
                   <asp:ListItem Text="3409">3409</asp:ListItem>
                   <asp:ListItem Text="3410">3410</asp:ListItem>                   
               </asp:DropDownList>
