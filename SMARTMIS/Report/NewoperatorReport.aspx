<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewoperatorReport.aspx.cs" Inherits="SmartMIS.Report.NewoperatorReport" MasterPageFile="~/smartMISMaster.Master"%>
...
<table width="100%"><tr><td width="95%" align="center"><h2>PCR Visual Inspection 
    Summary Report</h2></td>
...
<td width="25%" ><span class="masterLabel" style="padding-left: 5px; cursor:pointer;" onclick="toggleduration();">Duration :</span>
        ...
        <td style="width: 45%">
         ...
         <td style="font-weight:bold; font-family:Arial; font-size:small; width:15%">          
              Design:
               <asp:DropDownList ID="pcrDDldesign" runat="server"  Width="100" 
                                     onselectedindexchanged="ddlRecipe_SelectedIndexChanged">
...
<asp:GridView ID="grdinspectionsummary" runat="server" CssClass="TBMTable" 
        HeaderStyle-HorizontalAlign="Center" EmptyDataRowStyle-BackColor="Gray" 
            ...
            ShowFooter="false"  OnDataBound = "OnDataBound"
       >
     <Columns>
