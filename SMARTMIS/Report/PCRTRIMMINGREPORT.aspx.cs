...
namespace SmartMIS.Report
{
    public partial class PCRTRIMMINGREPORT : System.Web.UI.Page
    {
        ...
        protected void ViewButton_Click(object sender, EventArgs e)
        {
            ...
            string duration = ""; string DateTYpe = "";
            var datetimebt = "";
...
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' and wcName='" + wcname.TrimEnd() + "' and recipeCode='" + recipename + "' order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                ...
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' and wcName='" + wcname.TrimEnd() + "'  and shift='" + shift + "' order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                }
                else if (wcname != "ALL" && recipename == "All" && shift == "ALL")
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' and wcName='" + wcname + "'  order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                }
                else if (wcname == "ALL" && recipename != "All" && shift == "ALL")
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' and recipeCode='" + recipename + "'  order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                }
                else if (wcname == "ALL" && recipename != "All" && shift != "ALL")
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' and recipeCode='" + recipename + "'  and shift='" + shift + "' order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                ...
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "'  and shift='" + shift + "' order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
                }
                else
                {
                    myConnection.comm.CommandText = @"SELECT ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SNo,convert(char(10), dtandtime, 105)  as DATE, convert(varchar(8), dtandtime, 108) as TIME,
shift AS SHIFT ,gtbarcode AS BARCODE,recipeCode AS RECIPE ,SAPMaterialCode AS SAPCODE,wcName as MACHINENAME,CASE WHEN trimNo = '1' THEN 'NO' ELSE 'YES' END AS 'TRIMMING' FROM vTRIMMINGDATA where dtandtime>='" + nfromDate + "' and dtandtime<'" + ntoDate + "' order by dtandtime desc";// "select dbo.vCuringtbr.gtbarCode, dbo.vTbmtbR.recipeCode, convert(char(10), vCuringtbr.dtandtime, 105) AS Date,convert(char(10), vCuringtbr.dtandtime, 108) AS Time, dbo.vCuringtbr.wcName, dbo.vCuringtbr.shift FROM  dbo.vCuringtbr INNER JOIN dbo.vTbmtbR ON dbo.vCuringtbr.gtbarCode = dbo.vTbmtbR.gtbarCode  where dbo.vCuringtbr.dtandtime>='" + nfromDate + "' and dbo.vCuringtbr.dtandtime<'" + ntoDate + "' order by dbo.vCuringtbr.dtandtime desc";
        ...
        private void fillSizedropdownlist()
        {
            ...
            myConnection.open(ConnectionOption.SQL);
            myConnection.comm = myConnection.conn.CreateCommand();
            myConnection.comm.CommandText = "Select DISTINCT id as rID,name from recipemaster where description != '0' and description !='' and tyreSize!=''and processID = '7' order by name asc";
            myConnection.reader = myConnection.comm.ExecuteReader();
