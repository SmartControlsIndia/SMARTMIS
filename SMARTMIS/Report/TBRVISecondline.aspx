<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="TBRVISecondline.aspx.cs" Inherits="SmartMIS.Report.TBRVISecondline" Title="SMARTMIS" %>
<asp:Content ID="TBRVISECONDLNEontent" runat="server" ContentPlaceHolderID="masterContentPlaceHolder">
<style>
.links
{
...
<table width="100%"><tr><td width="95%" align="center"><h2>Second TBR Visual Inspection Report</h2></td>
...
<asp:Label ID="ShowWarning" runat="server" Text="" CssClass="alrtPopup" Visible="false"></asp:Label>
   <table cellpadding="0" cellspacing="0" style="width: 100%; border-style:solid; border-width:thin; border-color: #507CD1; background-color: #FFFFFF;" align="center">
    <tr>
        ...
        <td style="font-weight:bold; font-family:Arial; font-size:small; width:6%">  &nbsp;&nbsp;&nbsp;
                <asp:Button ID="ViewButton" runat="server" Text="View Report" onclick="ViewButton_Click" CssClass="button" />

            &nbsp;</td>
              <td style="font-weight:bold; font-family:Arial; font-size:small; width:2%"> Shift&nbsp; ::</td>

        
           <td style="font-weight:bold; font-family:Arial; font-size:small; width:3%">
           
               <asp:DropDownList ID="shiftDropdownlist" Width="100%" runat="server" AutoPostBack="true">
    ...
    AllowPaging="false" AllowSorting="false" PageSize="5" ShowFooter="False" >
       ...
       <Columns>
                                <asp:TemplateField HeaderText="NCMR">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="VIRecipeWiseTotalMinorLink" OnClick="VIRecipeWiseTotalMinor_Click" runat="server"><asp:Label ID="VIRecipeWiseTotalMinorLabel" runat="server" Text='<%# Eval("TotalNCMR") %>'></asp:Label><%= percent_sign %></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>      
    </asp:GridView> 
