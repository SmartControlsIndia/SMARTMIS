...
{
    public partial class CuringProductionReportNew : System.Web.UI.Page
    {
        ...
        protected void showReportDateWise(string fromDate, string toDate, string type)
        {
            ...
            if (validateInput("date", type, fromDate, toDate, 0, 0, 0))
            {
                switch (type)
                {
                    ...
                    case "RecipeWise":
                        showReportDayWcWise_withRecipe(fromDate, toDate);
                        break;
        ...
        protected void showReportMonthWise(int getMonth, int getYear, string type)
        {
            if (validateInput("month", type, "", "", getMonth, getYear, 0))
            {
                switch (type)
                {
                    ...
                    case "RecipeWise":
                        showReportMonthWcWise_withRecipe(getMonth, getYear);
                        break;
        ...
        protected void showReportYearWise(int getYearwise, string type)
        {
            if (validateInput("year", type, "", "", 0, 0, getYearwise))
            {
                switch (type)
                {
                    ...
                    case "RecipeWise":
                        showReportYearWcWise_withRecipe(getYearwise);
                        break;
        ...
        public bool validateInput(string duration, string type, string fromDate, string toDate, int month, int year, int yearwise)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "select TOP 1 1 AS getRowCount from vCuringProduction1 where wcName IN " + GetWcNameBYTranchWise(wcIDInQuery).ToString() + " AND " + durationQuery + " AND " + processType;
        ...
        public string GetWcNameBYTranchWise(string wcIDInQuery)
        {
            string strWC ="";

            try
            {
              string[] a =  wcIDInQuery.Split(',');
              foreach (var item in a)
              {
                  if (item.Contains('1'))
                  {
                      strWC += "3601 , 3602 , 3603 , 3604 , 3605 , 3606 , 3607 , 3608 , 3609 , 3610 , 3611 , 3612 , 3613 , 3614 , 3615 , 3616 , 4501 , 4502 , 4503 , 4504 , 4505 , 4506 , 4507 , 4508 , 4509 , 4510 , 4511 , 4512 , 4513 , 4514 , 4515".Trim();
                  }
                  if (item.Contains('2'))
                  {
                      strWC += ",4601, 4602, 4603, 4604, 4605, 4606, 4607, 4608, 4609, 4610, 4801, 4802, 4803, 4804, 4805, 4806, 4807, 4808, 4809, 4810, 4811, 4812, 4813, 4814, 4815".Trim();
                  }
                  if (item.Contains('3'))
                  {
                      strWC += ",4816, 4817, 4818, 4819, 4820, 4821, 4822, 4823, 4824, 4825, 4826, 4827, 4828, 4829, 4830, 4831, 4832, 4833, 4834, 4835, 4836, 4837, 4838, 4839, 4840, 4841, 4842, 4843, 4844, 4845".Trim();
                  }
                  if (item.Contains('4'))
                  {
                      strWC += "5401, 5402, 5403, 5404, 5405, 5406, 5407, 5408, 5409, 5410, 5411, 5412, 5413, 5414, 5415, 5416, 5417, 5418, 5419, 5420, 5421, 5422, 5423, 5424, 5425, 5426, 5427, 5428".Trim();
                  }
                  if (item.Contains('5'))
                  {
                      strWC += ",5429 , 5430 , 5431 , 5432 , 5433 , 5434 , 5435 , 5436 , 5437 , 5438 , 5439 , 5440 , 5441 , 5442 , 5443 , 5444 , 5445 , 5446 , 5447 , 5448 , 5449 , 5450 , 5451 , 5452 , 5453 , 5454 , 5455 , 5456".Trim();
                  }
                  if (item.Contains('6'))
                  {
                      strWC += ",5457 , 5458 , 5459 , 5460 , 5461 , 5462 , 5463 , 5464 , 5465 , 5466 , 5467 , 5468 , 5469 , 5470 , 5471 , 5472 , 5473 , 5474 , 5475 , 5476 , 5477 , 5478 , 5479 , 5480 , 5481 , 5482 , 5483 , 5484".Trim();
                  }
              }
            }
            catch (Exception ex)
        ...
        protected void showReportDayWcWise(string fromDate, string toDate)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select wcName, recipeCode,description, SAPMaterialCode , dtandTime from vCuringProduction1 WHERE wcName IN " + (GetWcNameBYTranchWise(wcIDInQuery)).ToString() + " AND " + processType + " AND " + durationQuery + " ORDER BY wcname asc , recipeCode, dtandTime";
                myConnection.reader = myConnection.comm.ExecuteReader();
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportDayWcWise_withRecipe(string fromDate, string toDate)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select wcName, recipeCode,description, SAPMaterialCode , dtandTime from vCuringProduction1 WHERE wcName IN " + (GetWcNameBYTranchWise(wcIDInQuery)).ToString() + " AND " + processType + " AND " + durationQuery + " " + sqlquery + " ORDER BY recipeCode,wcname, dtandTime";
                myConnection.reader = myConnection.comm.ExecuteReader();
                wcdt.Load(myConnection.reader);
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportDayRecipeWise(string fromDate, string toDate)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select recipeCode,description, SAPMaterialCode , dtandTime from vCuringProduction1 WHERE wcName IN " + (GetWcNameBYTranchWise(wcIDInQuery)).ToString() + " AND " + durationQuery + " " + sqlquery + " ORDER BY recipeCode, dtandTime";
                myConnection.reader = myConnection.comm.ExecuteReader();
                wcdt.Load(myConnection.reader);
...
.Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportDayOperatorWise(string fromDate, string toDate)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select manningID, firstName, lastName, dtandTime from vCuringProduction1 WHERE wcName IN " + (GetWcNameBYTranchWise(wcIDInQuery)).ToString() + " AND " + processType + " AND " + durationQuery + " " + sqlquery + " ORDER BY manningID, dtandTime";
                myConnection.reader = myConnection.comm.ExecuteReader();
                wcdt.Load(myConnection.reader);
...
.Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportMonthWcWise(int getMonth, int getYear)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select wcName, recipeCode,description,  SAPMaterialCode , dtandTime from vCuringProduction1 WHERE wcName IN " + GetWcNameBYTranchWise(wcIDInQuery).ToString() + " AND " + processType + " AND " + durationQuery + " ORDER BY wcID, recipeCode, dtandTime asc";
                myConnection.reader = myConnection.comm.ExecuteReader();
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportMonthWcWise_withRecipe(int getMonth, int getYear)
        {
            try
            {
                string sqlquery = (getRecipe != "All") ? " AND recipeID=" + getRecipe : "";
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportMonthRecipeWise(int getMonth, int getYear)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select wcName, recipeCode,description, SAPMaterialCode,dtandTime from vCuringProduction1 WHERE wcName IN " + GetWcNameBYTranchWise(wcIDInQuery).ToString() + " AND " + processType + " AND " + durationQuery + " " + sqlquery + "  ORDER BY recipeCode, dtandTime asc";
                myConnection.reader = myConnection.comm.ExecuteReader();
                dt.Load(myConnection.reader);
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[0].Text == "GrandTotal");
        ...
        protected void showReportMonthOperatorWise(int getMonth, int getYear)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select manningID, firstName, lastName, dtandTime from vCuringProduction1 WHERE wcName IN " + GetWcNameBYTranchWise(wcIDInQuery).ToString() + " AND " + processType + " AND " + durationQuery + " " + sqlquery + " ORDER BY  manningID, dtandTime asc";
                myConnection.reader = myConnection.comm.ExecuteReader();
                wcdt.Load(myConnection.reader);
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[1].Text == "Total");
        ...
        protected void showReportYearWcWise_withRecipe(int getYear)
        {
            string sqlquery = (getRecipe != "All") ? " AND recipeID=" + getRecipe : "";
    ...
    .Where(row => row.Cells[0].Text == "Total" || row.Cells[1].Text == "Total");
        ...
        protected void showReportYearRecipeWise(int getYear)
        {
            try
            {
                ...
                myConnection.comm.CommandText = "Select  recipeCode,description,SAPMaterialCode,dtandTime from vCuringProduction1 WHERE wcName IN " + GetWcNameBYTranchWise(wcIDInQuery).ToString() + " AND " + processType + " AND " + durationQuery + " " + sqlquery + "  ORDER BY  recipeCode, dtandTime asc";
                myConnection.reader = myConnection.comm.ExecuteReader();
                dt.Load(myConnection.reader);
