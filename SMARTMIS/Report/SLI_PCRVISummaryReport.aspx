<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SLI_PCRVISummaryReport.aspx.cs" MasterPageFile="~/smartMISMaster.Master" Inherits="SmartMIS.Report.SLI_PCRVISummaryReport" Title="PCR VI Second Line Inspection Report" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>PCR Second Line Inspection Report</h2></td>
    ...
    AllowPaging="false" AllowSorting="false" PageSize="5" ShowFooter="False" >   
       <Columns>
        ...
        <Columns>
                               ...
                               <Columns>
                                <asp:TemplateField HeaderText="OE Grade" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                            <asp:Label ID="VIRecipeWiseOE" runat="server" Text='<%# Eval("OE") %>'></asp:Label><%= percent_sign %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns> 
                            <Columns>
                                <asp:TemplateField HeaderText="Replacement" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                            <asp:Label ID="VIRecipeWiseReplacement" runat="server" Text='<%# Eval("Replacement") %>'></asp:Label><%= percent_sign %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>      
    </asp:GridView> 
