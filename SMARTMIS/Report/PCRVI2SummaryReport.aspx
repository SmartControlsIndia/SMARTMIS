<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCRVI2SummaryReport.aspx.cs" MasterPageFile="~/smartMISMaster.Master" Inherits="SmartMIS.Report.PCRVI2SummaryReport" Title="Smart MIS - Second PCR Visual Inspection Report" %>
...
<center><h2>Second PCR Visual Inspection Report</h2></center>
 <asp:Label ID="ShowWarning" runat="server" Text="" CssClass="alrtPopup" Visible="false"></asp:Label>
 <asp:ScriptManager ID="PCRVI2ScriptManager" AsyncPostBackTimeout="360000" runat="server"></asp:ScriptManager>
   ...
   <table cellpadding="0" cellspacing="0" style="width: 100%; border-style:solid; border-width:thin; border-color: #507CD1; background-color: #FFFFFF;" align="center">
    <tr>   
        ...
        <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">  &nbsp;&nbsp;&nbsp;
                <asp:Button ID="ViewButton" runat="server" CssClass="button" Text="View Report" onclick="ViewButton_Click" />
 ...
 --%>
   ...
   <asp:Panel ID="VIReportRecipeWiseMainPanel" runat="server" ScrollBars="None" Height="100%" CssClass="panel" Visible="false" >
       ...
       <table class="innerTable" cellspacing="1">
        <tr>
            <td class="gridViewHeader" style="width:25%; text-align:center; padding:5px" rowspan="2">Tyre Type</td>
            <td class="gridViewHeader" style="width:25%; text-align:center; padding:5px" rowspan="2">Total Checked</td>
            <td class="gridViewHeader" style="width:25%; text-align:center; padding:5px" rowspan="2">Total Buff</td>
            <td class="gridViewHeader" style="width:25%; text-align:center; padding:5px" rowspan="2">Total Repair</td>
    ...
    <RowStyle BackColor="#FCFCFC" ForeColor="#333333" />
        <Columns>
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="25%">
                <ItemTemplate>
        ...
        <Columns>
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="75%">
                <ItemTemplate>
                    ...
                    <asp:GridView ID="VIRecipeWiseChildGridView" runat="server" AutoGenerateColumns="False" 
                        ...
                        <RowStyle BackColor="#FFFFFF" ForeColor="#333333" />
                            <Columns>
                                <asp:TemplateField HeaderText="Checked" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="25%">
                                    <ItemTemplate>
                              ...
                              <Columns>
                                <asp:TemplateField HeaderText="Checked" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="25%">
                                    <ItemTemplate>
                                            <asp:Label ID="VIRecipeWiseBuffLabel" runat="server" Text='<%# Eval("TotalBuff") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                                ...
                                <asp:TemplateField HeaderText="Checked" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="25%">
                                    <ItemTemplate>
                                            <asp:Label ID="VIRecipeWiseNotOkLabel" runat="server" Text='<%# Eval("TotalRepair") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                ...
                <table width="100%"><tr align="center">
                    ...
                    <td  style="width:33%; text-align:center" class="gridViewItems"><%=totalcheckedcount %></td>
                    <td  style="width:33%; text-align:center" class="gridViewItems"><%=totalBuff%></td>
                    <td  style="width:33%; text-align:center" class="gridViewItems"><%=TotalRepair%></td>                  
                    </tr></table>
   ...
   <asp:Panel ID="PCRVI2SummaryReportPanel" runat="server" ScrollBars="None" Height="100%" CssClass="panel" Visible="false" >
        ...
        <Columns>
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="75%">
                ...
                <tr>
                    ...
                    <td style="width:11%;" align="center" class="gridViewfooterItems"><%=totalcheckedcount2%></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=reworkcount %></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=treadcount %></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=sidewallcount %></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=beadcount %></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=carcasscount %></td>
                    <td style="width:13%;" align="center" class="gridViewfooterItems"><%=otherscount %></td>
                 </tr>
    ...
    <asp:Panel ID="VI2FaultWisePanel" runat="server" ScrollBars="None" Height="100%" CssClass="panel" Visible="true" >
        ...
        <Columns>
                     ...
                     <RowStyle BackColor="#FFFFFF" ForeColor="#333333" />
                            <Columns>
                                <asp:TemplateField HeaderText="Checked" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="center" ItemStyle-Width="33%">
                                    <ItemTemplate>
                                            <asp:Label ID="VIfaltAreaCheckedLabel" runat="server" Text='<%# Eval("defectLocationName") %>' CssClass="gridViewItems"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
            ...
            <asp:TemplateField HeaderText="ID" HeaderStyle-CssClass="gridViewHeader" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="75%">
                ...
                <table width="100%"><tr>
                    ...
                    <td style="width:18%;" align="center" class="gridViewItems"><%=tyrecount%></td>
                </tr></table>
