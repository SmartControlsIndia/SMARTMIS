...
{
    public partial class ManualProductionReport : System.Web.UI.Page
    {
        ...
        private void Master_ButtonClick(object sender, EventArgs e)
        {
            ...
            string getProcess = ((smartMISTBMmanualproductionReport)this.Master).reportMasterWCProcessDropDownListValue;

            getType = ((smartMISTBMmanualproductionReport)this.Master).DropDownListTypeValue;
            duration = ((smartMISTBMmanualproductionReport)this.Master).DropDownListDurationValue;

            getOperator = ((smartMISTBMmanualproductionReport)this.Master).DropDownListOperatorsValue;

            string getDate = ((smartMISTBMmanualproductionReport)this.Master).reportMasterFromDateTextBoxValue;
            string getMonth = ((smartMISTBMmanualproductionReport)this.Master).DropDownListMonthValue;
            string getYear = ((smartMISTBMmanualproductionReport)this.Master).DropDownListYearValue;
            string getYearwise = ((smartMISTBMmanualproductionReport)this.Master).DropDownListYearWiseValue;

            ArrayList wcIDList = ((smartMISTBMmanualproductionReport)this.Master).reportMasterWCGridViewValue;
            ...
            SQLTable = (getProcess.ToString() == "tbmpcr12") ? "vTbmPCR" : (getProcess == "tbmtbr11" ? "vTbmTBR" : "");
