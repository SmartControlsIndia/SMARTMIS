<%@ Page Language="C#"  MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="SherographyData.aspx.cs" Inherits="SmartMIS.Report.SherographyData" Title="SMARTMIS"  %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>SHEROGRAPHY REPORT</h2></td>
         ...
         <myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" />
                    ...
                    <asp:ListItem Text="2019">2019</asp:ListItem>
                     <asp:ListItem Text="2020">2020</asp:ListItem>
                      <asp:ListItem Text="2021">2021</asp:ListItem>
                            ...
                            <td style="font-weight:bold; font-family:Arial; font-size:small; width:20%" visible="true"><span class="masterLabel" >MachineName :</span>             
               ...
               <asp:ListItem Text="ALL">ALL</asp:ListItem>
                   ...
                   <asp:ListItem Text="TBM9">TBM9</asp:ListItem>                  
                             ...
                             <td style="font-weight:bold; font-family:Arial; font-size:small; width:25%" visible="false"><span class="masterLabel" >Recipe :</span>             
             
               <asp:DropDownList ID="ddlRecipe" runat="server"  Width="170" Visible="true">
