<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="WeighingReport.aspx.cs" Inherits="SmartMIS.Report.WeighingReport" Title="Untitled Page" %>
...
<table width="100%"><tr><td width="55%" align="center"><h2>GT Weighing Report</h2></td>
<td width="5%" align="right"><div>
<asp:LinkButton runat="server" ID="excel" OnClick="exptoexcel_Click"><img src="../Images/Excel.jpg" alt="Export To Excel" class="imag" /></asp:LinkButton>

</div>
</td></tr></table>

<asp:ScriptManager ID= "gScriptManager" AsyncPostBackTimeout="360000" runat="server"></asp:ScriptManager>
...
<td width="25%" ><span class="masterLabel" style="padding-left: 5px; cursor:pointer;" onclick="toggleduration();">Duration :</span>
 ...
 <td style="font-weight:bold; font-family:Arial; font-size:small; width:10%">  &nbsp;&nbsp;&nbsp;
           <asp:Button ID="ViewButton" runat="server" Text="View Report" Onclick="Button_click" CssClass="button" />
...
<td><strong><asp:Label ID="rowCountLabel" runat="server" Text="Label" Visible="false"></asp:Label></strong></td>
...
<asp:Panel ID="ReportMonthWisePanel" runat="server" ScrollBars="Both" Height="90%" CssClass="panel" Visible="false" >
    <asp:GridView ID="MainGridView" runat="server" CssClass="TBMTable"
        HeaderStyle-HorizontalAlign="Left" EmptyDataRowStyle-BackColor="Gray" 
