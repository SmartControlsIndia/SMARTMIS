<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TBRvisualinspection2.aspx.cs" MasterPageFile="~/smartMISMaster.Master" Inherits="SmartMIS.Report.TBRvisualinspection2" Title="Smart MIS - Second TBR Visual Inspection Report" %>
...
<br />
    ...
    <tr>
        ...
        <td style="width: 8%"><myControl:calenderTextBox ID="tuoReportMasterFromDateTextBox" runat="server" Width="75%" /></td>
        <td style="font-weight:bold; font-family:Arial; font-size:small; width:3%">&nbsp;&nbsp;To::</td>
        <td style="width: 8%"><myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" /></td>
        ...
        <td style="font-weight:bold; font-family:Arial; font-size:small; width:10%">Display Type:  
        ...
        <td style="font-weight:bold; font-family:Arial; font-size:small; width:7%">&nbsp;</td>        
   </tr>
</table>
