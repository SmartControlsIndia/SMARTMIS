<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="PCRTRIMMINGREPORT.aspx.cs" Inherits="SmartMIS.Report.PCRTRIMMINGREPORT" Title="Untitled Page" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>PCR TRIMMING REPORT</h2></td>
...
<tr>
  ...
  <%--   <td width="8%"><span class="masterLabel" style="padding-left: 5px; cursor:pointer;">Select Process :</td>
<td width="20%">
        ...
        <td style="width: 45%">
         ...
         <myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" />
               ...
               <asp:ListItem Text="ALL">ALL</asp:ListItem>
                  <asp:ListItem Text="TRIMMING-1">TRIMMING -1</asp:ListItem>
                   <asp:ListItem Text="TRIMMING-2">TRIMMING -2</asp:ListItem>
                   <asp:ListItem Text="TRIMMING-3">TRIMMING -3</asp:ListItem>
                   <asp:ListItem Text="TRIMMING-4">TRIMMING -4</asp:ListItem>
                   <asp:ListItem Text="TRIMMING-5">TRIMMING -5</asp:ListItem>
                   <asp:ListItem Text="TRIMMING-6">TRIMMING -6</asp:ListItem>
