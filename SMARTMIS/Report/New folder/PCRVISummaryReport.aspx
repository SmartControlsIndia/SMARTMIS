<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCRVISummaryReport2.aspx.cs" MasterPageFile="~/smartMISMaster.Master" Inherits="SmartMIS.Report.PCRVISummaryReport2" Title="Smart MIS - Second PCR Visual Inspection Report" %>

<asp:Content ID="PCRVISummaryReport2Content" runat="server" ContentPlaceHolderID="masterContentPlaceHolder">
    <style>
.links
{
