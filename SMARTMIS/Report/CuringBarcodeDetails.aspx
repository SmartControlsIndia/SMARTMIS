<%@ Page Language="C#" MasterPageFile="~/smartMISMaster.Master" AutoEventWireup="true" CodeBehind="CuringBarcodeDetails.aspx.cs" Inherits="SmartMIS.Report.CuringBarcodeDetails" Title="SMARMIS" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>Curing Barcode Report</h2></td>
...
<td width="25%" ><span class="masterLabel" onclick="toggleduration();">Duration :</span>
        ...
        <td style="width: 45%">
         ...
         <myControl:calenderTextBox ID="tuoReportMasterToDateTextBox" runat="server" Width="75%" />
                             ...
                             <td style="font-weight:bold; font-family:Arial; font-size:small; width:15%" visible="false">          
             
               <asp:DropDownList ID="ddlRecipe" runat="server"  Width="100" 
                                     onselectedindexchanged="ddlRecipe_SelectedIndexChanged" Visible="false">
