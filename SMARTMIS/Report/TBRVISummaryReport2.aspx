<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TBRVISummaryReport2.aspx.cs" MasterPageFile="~/smartMISMaster.Master" Inherits="SmartMIS.Report.TBRVISummaryReport2" Title="Smart MIS - First TBR Visual Inspection Report" %>
...
<table width="100%"><tr><td width="95%" align="center"><h2>First TBR Visual Inspection Report</h2></td>
       ...
       <Columns>
        ...
        <Columns>
                                <asp:TemplateField HeaderText="Rework">
                                    <ItemTemplate>
                                            <asp:LinkButton ID="VIRecipeWiseNotOk" OnClick="VIRecipeWiseTotalMinor_Click" runat="server"><asp:Label ID="VIRecipeWiseNotOkLabel" runat="server" Text='<%# Eval("TotalRepair") %>'></asp:Label><%= percent_sign %></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
       <Columns>
